...
export default function WhatsAppAutomationContent({
  ...
  const serviceJsonLd = {
    ...
    description:
      "WhatsApp Business API automation services for companies in the Netherlands — chatbot development, customer service automation, marketing campaigns, and CRM integration via WhatsApp.",
    serviceType: "WhatsApp Business API Integration & Automation",
    offers: {
      "@type": "Offer",
      price: "0.00",
      priceCurrency: "EUR",
      description: "Free WhatsApp automation consultation",
    },
  };
