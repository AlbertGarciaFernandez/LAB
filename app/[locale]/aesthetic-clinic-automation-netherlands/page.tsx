...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: "Aesthetic Clinic Automation Netherlands — CodeHunter Lab",
      description:
        "Turn more aesthetic clinic inquiries into booked treatments with custom CRM, lead nurturing, and booking automation systems. Built for cosmetic and dermatology clinics in the Netherlands.",
