...
import { FileTextIcon, BrainIcon, HeadsetIcon, ScalesIcon, FirstAidKitIcon, CodeIcon } from "@phosphor-icons/react/dist/ssr";
...
export default function CustomLLMPageContent() {
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Custom LLM Development", "item": `https://www.codehunterlab.com/en/expertise/custom-llm-development` }
        ]
    };
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {t.raw("Features.cards").map((card: any) => (
                            <GlassCard key={card.title} hoverEffect={true} glowColor="green" className="p-10 flex flex-col h-full">
