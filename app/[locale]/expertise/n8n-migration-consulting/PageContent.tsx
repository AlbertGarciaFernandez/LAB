...
import { UsersIcon, EnvelopeIcon, ChartBarIcon, ShoppingCartIcon, ReceiptIcon, PlugsConnectedIcon } from "@phosphor-icons/react/dist/ssr";

const useCaseIcons = [UsersIcon, EnvelopeIcon, ChartBarIcon, ShoppingCartIcon, ReceiptIcon, PlugsConnectedIcon];
...
export default function N8nMigrationPageContent() {
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "n8n Migration Consulting", "item": `https://www.codehunterlab.com/en/expertise/n8n-migration-consulting` }
        ]
    };
                            ...
                            return (
                                <GlassCard key={key} glowColor={negative ? undefined : "orange"} className={`p-8 ${!negative ? "border-hunter-orange/30" : ""}`}>
                                    ...
                                    <ul className="space-y-3">
                                        {(col.cons || col.pros).map((item: string) => (
            ...
            <section className="py-24 relative z-10 border-t border-white/5 bg-near-black/50">
                <div className="max-w-3xl mx-auto px-6">
                    ...
                    <div className="space-y-6">
                        {t.raw("FAQ.items").map((item: any) => (
                            <div key={item.q} className="p-8 rounded-2xl border border-white/5 bg-white/2">
