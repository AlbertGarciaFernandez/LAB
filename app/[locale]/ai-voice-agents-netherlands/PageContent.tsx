...
export default function AIVoiceAgentsContent({
  ...
  const serviceJsonLd = {
    ...
    description:
      "Custom AI voice agent solutions for businesses in the Netherlands — inbound call handling, lead qualification, appointment scheduling, and 24/7 phone support powered by conversational AI.",
    serviceType: "AI Voice Agent Development & Integration",
    offers: {
      "@type": "Offer",
      price: "0.00",
      priceCurrency: "EUR",
      description: "Free AI voice agent consultation",
    },
  };
            ...
            >
              <div className="rounded-2xl border border-hunter-green/20 bg-surface-dark/70 p-6 shadow-[0_0_60px_rgba(0,230,162,0.12)] backdrop-blur-md">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {voiceTechStack.slice(0, 8).map((tool) => (
                    <div
                      key={tool}
