...
export default function AIAutomationNetherlandsContent() {
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "AI Automation Netherlands", "item": `https://www.codehunterlab.com/en/ai-automation-consulting-netherlands` }
        ]
    };
        ...
        <main className="relative min-h-screen bg-near-black text-white overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <GlassCard hoverEffect={true} glowColor="green" className="p-8">
                            ...
                            <div className="border-t border-white/10 pt-4">
                                ...
                                <ul className="space-y-2 text-sm text-gray-300">
                                    {(t.raw("Agents.whatsapp.points") as string[]).map((point) => (
                                        <li key={point} className="flex gap-2 items-center"><span className="text-hunter-green">●</span> {point}</li>
                                    ))}
                                </ul>
                            </div>
                        </GlassCard>
                        ...
                        <GlassCard hoverEffect={true} glowColor="green" className="p-8 bg-hunter-green/5 border-hunter-green/30 relative overflow-hidden">
                            ...
                            <div className="border-t border-white/10 pt-4">
                                <h4 className="text-sm font-bold text-hunter-green mb-2 uppercase tracking-wider">{t("Agents.label.capabilities")}</h4>
                                <ul className="space-y-2 text-sm text-gray-300">
                                    {(t.raw("Agents.voice.points") as string[]).map((point) => (
                                        <li key={point} className="flex gap-2 items-center"><span className="text-hunter-green">●</span> {point}</li>
                                    ))}
                                </ul>
                            </div>
                        ...
                        <GlassCard hoverEffect={true} glowColor="green" className="p-8">
                            ...
                            <div className="border-t border-white/10 pt-4">
                                <h4 className="text-sm font-bold text-hunter-green mb-2 uppercase tracking-wider">{t("Agents.label.capabilities")}</h4>
                                <ul className="space-y-2 text-sm text-gray-300">
                                    {(t.raw("Agents.automation.points") as string[]).map((point) => (
                                        <li key={point} className="flex gap-2 items-center"><span className="text-hunter-green">●</span> {point}</li>
                                    ))}
                                </ul>
                            </div>
                ...
                <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-12 text-left">
                    <div>
                        ...
                        <ul className="space-y-6 text-gray-400">
                            {(["0", "1"] as const).map((n) => (
                                <li key={`dont-${n}`} className="flex items-start gap-4 p-4 rounded-xl bg-red-500/5 border border-red-500/10">
                                    <span className="text-red-500 text-2xl font-bold">✕</span>
                                    <span className="leading-relaxed">{t(`Trust.dont.points.${n}`)}</span>
                                </li>
                            ))}
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-6 text-gray-300">
                            {(["0", "1"] as const).map((n) => (
                                <li key={`do-${n}`} className="flex items-start gap-4 p-4 rounded-xl bg-hunter-green/5 border border-hunter-green/10">
                                    <span className="text-hunter-green text-2xl font-bold">✓</span>
                                    <span className="leading-relaxed" dangerouslySetInnerHTML={{ __html: t.raw(`Trust.do.points.${n}`) }} />
                                </li>
                            ))}
                        </ul>
                    </div>
            ...
            <section className="py-32 relative z-10 max-w-4xl mx-auto px-6 border-t border-white/5">
                ...
                <div className="space-y-6">
                    {t.raw("SEO.faq.questions").map((item: any) => (
                        <GlassCard key={item.q} className="p-8 group" hoverEffect={true} glowColor="green">
