...
import { CheckIcon, PhoneIcon, HouseIcon, ChartBarIcon, ArrowsClockwiseIcon, PlugsConnectedIcon, ChatCircleDotsIcon, LightningIcon, CalendarCheckIcon, StarIcon } from "@phosphor-icons/react/dist/ssr";

const painPointIcons = [PhoneIcon, HouseIcon, ChartBarIcon, ArrowsClockwiseIcon, PlugsConnectedIcon, ChatCircleDotsIcon];
const solutionIcons = [LightningIcon, CalendarCheckIcon, HouseIcon, ChartBarIcon, ArrowsClockwiseIcon, StarIcon];
...
const realEstateSystems = [
    "Funda", "HubSpot", "WhatsApp Business API", "n8n", "Brevo",
    "Google Ads", "Meta Ads", "Zapier", "Calendly", "ActiveCampaign",
];

export default function RealEstateAutomation({ params: { locale } }: { params: { locale: string } }) {
    ...
    const serviceJsonLd = {
        ...
        "description": "Custom automation and CRM integration systems for real estate agencies in the Netherlands — lead follow-up, property listing automation, viewing scheduling, and client dashboards.",
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Real Estate Agency Automation Netherlands", "item": `${baseUrl}/${locale}${path}` },
        ],
    };
        ...
        <main className="relative min-h-screen bg-near-black text-white overflow-hidden">
            ...
            <section className="py-12 border-y border-white/5 bg-near-black/50 backdrop-blur-sm relative z-10 overflow-hidden mt-8">
                <div className="flex space-x-12 animate-marquee whitespace-nowrap opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
                    {[...realEstateSystems, ...realEstateSystems].map((sys, i) => (
