    ...
    <div className="space-y-6">
      <section className="grid gap-4 xl:grid-cols-[1.15fr_0.85fr]">
        <LabCard className="bg-[linear-gradient(135deg,#fffefb_0%,#f4efe6_100%)]">
          ...
          <p className="text-black/62 mt-4 max-w-3xl text-base leading-7">
            {system.shortDescription}
          </p>
          <p className="text-black/58 mt-4 max-w-3xl text-sm leading-7">{system.overview}</p>
        </LabCard>
        ...
        <LabCard>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            ...
            <span className="border-black/8 text-black/62 rounded-full border bg-[#faf7f2] px-4 py-2 text-sm">
              {system.modules.length} module{system.modules.length === 1 ? "" : "s"}
            </span>
          </div>
          <p className="mt-5 text-sm leading-6 text-black/60">
            This view is meant to help the team locate the next concrete implementation step, not
            turn the system into a generic course outline.
          </p>
        </LabCard>
      </section>
      ...
      <section>
        <div className="mb-4">
          ...
          <h2 className="mt-2 text-2xl font-semibold tracking-[-0.04em] text-black">
            The work is broken into focused modules.
          </h2>
        </div>
