...
import { CheckIcon, FileTextIcon, CalendarCheckIcon, ArrowsClockwiseIcon, ChartBarIcon, PlugsConnectedIcon, ChatCircleDotsIcon, RocketIcon, BriefcaseIcon } from "@phosphor-icons/react/dist/ssr";

const painPointIcons = [FileTextIcon, CalendarCheckIcon, ArrowsClockwiseIcon, ChartBarIcon, PlugsConnectedIcon, ChatCircleDotsIcon];
const solutionIcons = [FileTextIcon, CalendarCheckIcon, RocketIcon, ChartBarIcon, ArrowsClockwiseIcon, BriefcaseIcon];
...
const accountingSystems = [
    "Exact Online", "Twinfield", "Moneybird", "n8n", "HubSpot",
    "Microsoft 365", "Mollie", "Slack", "ActiveCampaign", "Zapier",
];

export default function AccountingFirmAutomation({ params: { locale } }: { params: { locale: string } }) {
    ...
    const serviceJsonLd = {
        ...
        "description": "Custom automation and CRM integration systems for accounting firms in the Netherlands — invoice processing, client onboarding, deadline reminders, and financial reporting dashboards.",
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Accounting Firm Automation Netherlands", "item": `${baseUrl}/${locale}${path}` },
        ],
    };
        ...
        <main className="relative min-h-screen bg-near-black text-white overflow-hidden">
            ...
            <section className="py-12 border-y border-white/5 bg-near-black/50 backdrop-blur-sm relative z-10 overflow-hidden mt-8">
                <div className="flex space-x-12 animate-marquee whitespace-nowrap opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
                    {[...accountingSystems, ...accountingSystems].map((sys, i) => (
