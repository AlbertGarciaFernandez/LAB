                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <GlassCard className="p-10 bg-white/[0.02]" hoverEffect={false}>
                            <div className="flex items-center gap-3 mb-8">
                                ...
                                <h3 className="text-2xl font-black text-white/50 uppercase tracking-tight">{t("Comparison.hiring.title")}</h3>
                            </div>
                            <ul className="space-y-4">
                                {hiringPoints.map((point, idx) => (
                                    <li key={idx} className="flex items-start gap-4">
                                        <XIcon className="w-5 h-5 text-gray-600 mt-0.5 flex-shrink-0" />
