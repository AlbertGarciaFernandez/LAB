...
export default function CustomInternalToolsContent() {
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Services", "item": `https://www.codehunterlab.com/en/services` },
            { "@type": "ListItem", "position": 3, "name": "Custom Internal Tools", "item": `https://www.codehunterlab.com/en/services/custom-internal-tools-development` }
        ]
    };
                        ...
                        <GlassCard className="p-10 border-red-500/20 bg-red-900/5 hover:bg-red-900/10 opacity-70 transition-all" hoverEffect={false}>
                            ...
                            <ul className="space-y-6">
                                {(t.raw("Comparison.lowcode.points") as string[]).map((point) => (
                                    <li key={point} className="flex gap-4 text-gray-400 text-lg">
                        ...
                        <GlassCard className="p-10 border-purple-500/30 bg-purple-900/10 relative overflow-hidden ring-2 ring-purple-500/20" hoverEffect={true} glowColor="orange">
                            ...
                            <ul className="space-y-6">
                                {(t.raw("Comparison.custom.points") as string[]).map((point) => (
                                    <li key={point} className="flex gap-4 text-white text-lg font-medium">
            ...
            <section className="py-32 relative z-10 max-w-4xl mx-auto px-6 border-t border-white/5">
                ...
                <div className="space-y-6">
                    {t.raw("FAQ.questions").map((item: any) => (
                        <GlassCard key={item.q} className="p-8 group" hoverEffect={true} glowColor="orange">
