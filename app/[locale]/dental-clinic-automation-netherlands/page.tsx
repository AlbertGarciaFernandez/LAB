...
const dentalSystems = [
    "Exquise", "ISOS", "Dentrix", "WhatsApp Business API", "n8n", "HubSpot",
    "Google Ads", "Meta Ads", "Mollie", "Calendly", "ActiveCampaign",
];

export default function DentalClinicAutomation({ params: { locale } }: { params: { locale: string } }) {
    const t = useTranslations("DentalClinic");
    ...
    const serviceJsonLd = {
        ...
        "description": "Custom automation and CRM integration systems for dental clinics in the Netherlands — appointment reminders, patient recall campaigns, lead-to-booking automation, and practice dashboards.",
        "serviceType": "Dental Practice Automation & Integration",
        "offers": {
            "@type": "Offer",
            "price": "0.00",
            "priceCurrency": "EUR",
            "description": "Free dental practice automation audit",
        },
    };
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Dental Clinic Automation Netherlands", "item": `${baseUrl}/${locale}${path}` },
        ],
    };
        ...
        <main className="relative min-h-screen bg-near-black text-white overflow-hidden">
            ...
            <section className="py-12 border-y border-white/5 bg-near-black/50 backdrop-blur-sm relative z-10 overflow-hidden mt-8">
                <div className="flex space-x-12 animate-marquee whitespace-nowrap opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
                    {[...dentalSystems, ...dentalSystems].map((sys, i) => (
