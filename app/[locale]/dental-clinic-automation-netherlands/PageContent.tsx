...
type PageProps = {
  ...
  scenarios: { title: string; items: ScenarioItem[] };
  whyUs: { title: string; points: WhyUsPoint[] };
...
export default function DentalClinicAutomationContent({
  ...
  const serviceJsonLd = {
    ...
    description:
      "Custom automation and CRM integration systems for dental clinics in the Netherlands — appointment reminders, patient recall campaigns, lead-to-booking automation, and practice dashboards.",
