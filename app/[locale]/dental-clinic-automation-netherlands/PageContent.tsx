...
export default function DentalClinicAutomationContent() {
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Dental Clinic Automation Netherlands", "item": `https://www.codehunterlab.com/en/dental-clinic-automation-netherlands` },
        ],
    };
