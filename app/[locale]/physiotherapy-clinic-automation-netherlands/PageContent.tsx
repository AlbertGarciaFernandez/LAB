...
export default function PhysiotherapyClinicAutomationContent() {
  ...
  const serviceJsonLd = {
    ...
    description:
      "Custom automation and integration systems for physiotherapy practices in the Netherlands — referral intake automation, appointment reminders, patient drop-out detection, Zorgdomein integration, and practice analytics dashboards.",
