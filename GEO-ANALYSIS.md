...
_Analysis performed by Claude Code (claude-sonnet-4-6) on 2026-03-10. Based on static file analysis of Next.js 14 codebase. Live site behavior (JavaScript rendering, HTTP headers, actual crawler access) requires separate dynamic testing._
