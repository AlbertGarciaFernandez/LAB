  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        <h2 className="mb-4 text-center text-4xl font-extrabold tracking-tight md:text-5xl">
            ...
            {pillars.map((pillar, i) => {
              ...
              return (
                <motion.button
                  ...
                  whileHover={{
                    y: -6,
                    boxShadow: "0 0 0 1px rgba(0,230,162,0.5)",
                  }}
                  className={`group relative flex h-full flex-col rounded-2xl border bg-surface-dark/70 p-6 text-left transition ${
                    isActive ? "border-hunter-green/60" : "border-white/5"
                  }`}
                >
                  {/* gradient hover */}
                  <div className="pointer-events-none absolute inset-0 rounded-2xl opacity-0 transition-opacity group-hover:bg-gradient-to-br group-hover:from-hunter-green/10 group-hover:via-transparent group-hover:to-hunter-orange/10 group-hover:opacity-100" />
                  ...
                  <div className="relative flex items-center gap-3">
                    <div className="">
                      <span className="text-4xl text-hunter-green mb-4 block font-mono">
                        {pillar.icon}
                      </span>
                    </div>
                    <h3 className="text-base font-display font-semibold md:text-lg">
                      {pillar.title}
                    </h3>
                  </div>
                  ...
                  <span className="relative mt-4 inline-flex items-center text-[11px] font-medium text-hunter-green/80 group-hover:text-hunter-green">
          ...
          <div className="mt-4 lg:mt-0">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h3 className="mt-2 text-xl font-display font-semibold text-white md:text-2xl">
