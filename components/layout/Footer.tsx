        ...
        <footer className="relative bg-near-black pt-24 pb-12 px-6 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
                    ...
                    {/* Services */}
                    <div>
                        <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-8">{t("Services.title")}</h4>
                    ...
                    {/* Industries */}
                    <div>
                        <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-8">{t("Industries.title")}</h4>
                        <ul className="space-y-4">
                            {[
                    ...
                    <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-[10px] font-bold text-hunter-green uppercase tracking-[0.2em]">{t("Availability.nextOpening", { date: "Q1 2026" })}</span>
                        </div>
                ...
                <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex flex-col md:flex-row items-center gap-2 md:gap-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-gray-600">·</span>
                            <Link href="/#contact" className="text-[11px] font-bold text-hunter-green/80 uppercase tracking-widest hover:text-hunter-green transition-colors">
