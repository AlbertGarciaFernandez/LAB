...
export const TechIcons = {
  ...
  Figma: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M12 12H8C6 12 4 10 4 8C4 6 6 4 8 4H12V12Z" fill="currentColor" fillOpacity="0.5" />
      <path
      ...
      <path
        ...
        fillOpacity="0.5"
      />
      <path d="M12 12H8C6 12 4 14 4 16C4 18 6 20 8 20" stroke="currentColor" strokeWidth="2" />
    </svg>
  ),
  Git: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M10 8V15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
  ...
  PostgreSQL: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M12 2C7.58 2 4 5.58 4 10C4 14.42 7.58 18 12 18C13.1 18 14.15 17.78 15.1 17.38L19 21L21 19L17.38 15.1C17.78 14.15 18 13.1 18 12C18 7.58 14.42 4 12 4V2Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
  ...
  OpenAI: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M12 2C10.9 2 10 2.9 10 4V6H14V4C14 2.9 13.1 2 12 2Z"
        stroke="currentColor"
        strokeWidth="2"
      />
      <path
      ...
      />
      <path
        d="M4 10C2.9 10 2 10.9 2 12C2 13.1 2.9 14 4 14H6V10H4Z"
        stroke="currentColor"
        strokeWidth="2"
      />
      <path
        d="M20 10H18V14H20C21.1 14 22 13.1 22 12C22 10.9 21.1 10 20 10Z"
        stroke="currentColor"
        strokeWidth="2"
      />
  ...
  Python: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M8 5C8 4 8.9 3 11 3H13C15.1 3 16 4 16 5V10H8V5Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <path
        d="M16 19C16 20 15.1 21 13 21H11C8.9 21 8 20 8 19V14H16V19Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <path
        d="M8 10H5C3.9 10 3 10.9 3 12C3 13.1 3.9 14 5 14H8"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <path
        d="M16 10H19C20.1 10 21 10.9 21 12C21 13.1 20.1 14 19 14H16"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
  ...
  Docker: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path
        d="M2 13.5C2 16.5 5 18 8.5 18H15C18.5 18 22 16.5 22 13.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <path
        d="M17 9V8C18.5 8 19.5 7 20 6"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
  ...
  LangChain: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M9 9H6C4.3 9 3 10.3 3 12C3 13.7 4.3 15 6 15H9"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M15 9H18C19.7 9 21 10.3 21 12C21 13.7 19.7 15 18 15H15"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
  ...
  Redis: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path
        d="M3 12C3 13.657 7.03 15 12 15C16.97 15 21 13.657 21 12"
        stroke="currentColor"
        strokeWidth="1.5"
      />
    </svg>
  ...
  Stripe: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M17 8C17 8 15 6 12 6C9 6 7 7.5 7 9.5C7 11.5 9 12.5 12 13C15 13.5 17 14.5 17 16.5C17 18.5 15 20 12 20C9 20 7 18 7 18"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
